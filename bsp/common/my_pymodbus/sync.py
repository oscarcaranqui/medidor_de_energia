...
class ModbusSerialClient(BaseModbusClient):
    ...
    def __init__(self, method='ascii', fn_de_re_send=lambda: None, fn_de_re_receive=lambda: None,  **kwargs):
        ...
        ##--##--
        self.fn_de_re_send = fn_de_re_send
        self.fn_de_re_receive = fn_de_re_receive
    ...
    def _send(self, request):
        ...
        if request:
            ...
            ##--##--
            time.sleep((len(request) * 10 / self.socket.baudrate) + 0.0005)
